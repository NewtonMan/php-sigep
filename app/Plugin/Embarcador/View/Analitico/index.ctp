    ...
    <table class="table table-striped table-condensed">
        ...
        <?php foreach ($this->request->data['lista'] as $i) { ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-primary btn-lg" href="/embarcador/encomendas/monitoramento/<?= $i['Destino']['id'] ?>">Encomendas</a>
                    <a class="btn btn-primary btn-lg" href="/embarcador/analitico/calendario/<?= $i['Destino']['id'] ?>">Relatórios</a>
                    <a class="btn btn-primary btn-lg" href="/embarcador/encomendas/relatorio/<?= $i['Destino']['id'] ?>">Exportar Planilha</a>
                    <a class="btn btn-primary btn-lg" href="/embarcador/importar">Importar Planilha</a>
                    <a class="btn btn-danger btn-lg" href="/embarcador/analitico/gerenciar_sla/<?= $i['Destino']['id'] ?>">Gerenciar SLA</a>
                    <!--
